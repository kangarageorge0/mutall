...
//Creating a class with empty class results
  class empty_exam_results extends outlook.baby<void>{
     ...
     */
    async page_header_show():Promise<void>{
        //
        //Get the page section
        const header:HTMLElement = this.get_element('crown');
        //
        ...
        const items:Array<factor> = this.filter_factors;
        //
    ...
    async show_table():Promise<void>{
        ...
        this.table =  <HTMLTableElement>this.get_element('matrix');
        //
    ...
    async body_data_get():Promise <Array<fuel>>{
        //
